...
const Page = () => {
  ...
  return (
    <Fragment>
      ...
      <div
        className={`mt-8 ${
          gridLayout ? "grid grid-cols-1 md:grid-cols-2 gap-8 mt-8" : ""
        }`}
      >
        {Array(20)
          .fill(0)
          .map(() => (
            ...
            <div
              ...
              className={`font-tertiary ${
                gridLayout
                  ? ""
                  : "flex flex-col md:flex-row items-center gap-x-8 mb-8"
              }`}
            >
              <div
                className={`${
                  gridLayout
                    ? "bg-grayF6  cursor-pointer"
                    : "bg-grayF6 flex items-center justify-center w-full md:w-[350px] flex-shrink-0"
                } h-[300px] md:h-[340px] lg:h-[360px] 2xl:h-[380px]`}
              >
                <Image
                  src={Blog}
                  alt="Blog Item"
        ...
        <div className="mt-8">
          ...
          {Array(24)
            ...
            .map(() => (
              ...
              >
                <div className="bg-grayF6 flex items-center justify-center w-full md:w-[350px] h-[400px] flex-shrink-0">
                  <Image
                    src={Blog}
                    alt="Product"
                ...
                <div className="flex flex-col justify-center">
                  ...
                  <p className="text-base md:text-lg text-grayC mb-4">
                    ...
                    quam quas laudantium doloremque, harum alias adipisci dicta.
                  </p>
