"use client";
import { HeartIcon, StarIcon } from "@/app/_icons";
import { Select } from "antd";
import Image from "next/image";
import React, { useState } from "react";
import Product from "@/app/_assets/images/trending3.png";
  ...
  return (
    <div className="">
      <div className="flex justify-between items-center mb-20">
        <GridListLayout setGridLayout={setGridLayout} gridLayout={gridLayout} />
