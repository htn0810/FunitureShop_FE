      ...
      <div className="px-[200px]">
        <div className="flex gap-8">
          ...
          <div className="flex flex-col justify-center">
            ...
            <p className="text-base md:text-lg text-grayC">
            ...
            <div className="flex items-center gap-x-2">
              <button className="uppercase font-tertiary font-semibold text-white text-base md:text-lg px-5 py-3 bg-grayDarkC rounded-md">
                Add to cart
              </button>
              <button className="text-white px-5 py-3 bg-grayDarkC rounded-md flex items-center justify-center">
                <FindIcon className="" />
              </button>
            </div>
          </div>
