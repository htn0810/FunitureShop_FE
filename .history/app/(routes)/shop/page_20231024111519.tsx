      ...
      <div className="grid grid-cols-2 md:grid-cols-4 xl:grid-cols-6 gap-8">
        ...
        <div className="overflow-hidden">
          <div className="relative h-[250px] md:h-[300px] overflow-hidden">
            <div className="bg-grayF6 relative flex items-center justify-center h-[250px] md:h-[300px] mb-4">
              <Image src={Product} alt="Product" className="" />
            </div>
            <div className="w-full absolute flex items-center justify-between px-4 py-3 bottom-[-10px] right-0 left-0 h-12 bg-black text-white">
