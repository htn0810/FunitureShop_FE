    ...
    <div className="">
      ...
      <div className="grid grid-cols-2 md:grid-cols-4 xl:grid-cols-6 gap-8">
        ...
        <div className="overflow-hidden">
          <div className="bg-grayF6 flex items-center justify-center h-[250px] md:h-[300px] mb-4">
            <Image src={Product} alt="Product" className="" />
          </div>
          <h3 className="font-tertiary font-semibold text-md md:text-lg xl:text-xl text-black hover:text-darkYellow cursor-pointer mb-4">
