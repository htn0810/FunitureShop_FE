      ...
      <div className="grid grid-cols-2 md:grid-cols-4 xl:grid-cols-6 gap-8">
        ...
        <div className="group">
          <div className="relative h-[250px] md:h-[300px] overflow-hidden mb-4">
            ...
            <div className="w-full absolute flex items-center justify-between px-4 py-3 bottom-0 translate-y-full group-hover:translate-y-0 transition-all duration-200 ease-in right-0 left-0 h-12 bg-black text-white">
              <button className="hover:text-darkYellow"> Add to cart</button>
              <HeartIcon />
            </div>
          </div>
