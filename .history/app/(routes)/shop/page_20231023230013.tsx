  ...
  return (
    <div className="bg-lightYellow h-[200px] px-[15px] md:px-[40px] xl:px-[90px] mb-20 mx-[-15px] md:mx-[-40px] xl:mx-[-90px]">
      <div className="grid grid-cols-5">
        ...
        <div className="col-start-3 col-end-6 flex items-center flex-1">
          <input
            type="text"
            placeholder="Search here..."
            className="h-[40px] outline-none px-3"
          />
          <button className="h-[40px] ww-full px-3 bg-pinkC opacity-95">
