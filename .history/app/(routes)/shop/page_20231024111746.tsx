      ...
      <div className="grid grid-cols-2 md:grid-cols-4 xl:grid-cols-6 gap-8">
        ...
        <div className="group">
          <div className="relative h-[250px] md:h-[300px] overflow-hidden mb-4">
            ...
            <div className="w-full absolute flex items-center justify-between px-4 py-3 bottom-[-10] group-hover:bottom-0 transition-all duration-150 right-0 left-0 h-12 bg-black text-white">
