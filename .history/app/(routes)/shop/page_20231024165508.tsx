    ...
    <div className="">
      ...
      <div className="px-[200px]">
        <div className="flex gap-8">
          <div className="bg-grayF6 flex items-center justify-center w-[500px] h-[400px] flex-shrink-0">
            <Image
              src={Product}
              alt="Product"
          ...
          <div className="flex flex-col justify-center">
            ...
            <div className="flex items-center gap-x-2">
              <button className="uppercase font-tertiary font-semibold text-white text-base md:text-lg px-5 h-14 bg-grayDarkC rounded-md">
                Add to cart
              </button>
              <button className="text-white px-5 h-14 bg-grayDarkC rounded-md flex items-center justify-center">
                <FindIcon className="" />
              </button>
            </div>
          </div>
