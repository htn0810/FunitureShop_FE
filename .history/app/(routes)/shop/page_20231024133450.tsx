  ...
  return (
    <div className="">
      ...
      <div className="px-[200px]">
        <div className="flex">
          <div className="bg-grayF6 flex items-center justify-center w-[350px] h-[400px]">
            <Image
              src={Product}
              alt="Product"
              width={200}
          ...
          <div className="flex flex-col">
            <h3 className="uppercase font-semibold text-2xl text-black hover:text-darkYellow">
              Condimentum posuere
            </h3>
          </div>
        </div>
