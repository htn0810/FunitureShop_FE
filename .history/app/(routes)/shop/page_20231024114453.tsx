        ...
        {Array(24)
          ...
          .map(() => (
            <div key={randomUUID} className="group">
              <div className="relative h-[250px] xl:h-[275px] 2xl:h-[300px] overflow-hidden mb-4">
                <div className="bg-grayF6 relative flex items-center justify-center h-[250px] xl:h-[275px] 2xl:h-[300px]">
