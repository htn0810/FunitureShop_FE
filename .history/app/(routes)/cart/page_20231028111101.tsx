...
import { ICartProduct } from "@/app/_types/general.type";
    ...
    <div className="mt-8">
      ...
      <div className="flex mt-16 font-tertiary gap-8">
        ...
        <div className="basis-1/2">
          ...
          <div className="px-6 py-4 border border-gray-300">
            <div className="flex justify-between mb-4">
              <span>Subtotal</span>
              <span className="text-lg text-grayC">$215.00</span>
            </div>
            <div className="flex justify-between mb-4">
              <span>Shipping</span>
              <span className="text-lg text-grayC">$15.00</span>
            </div>
            <div className="w-full h-[1px] bg-gray-300 mb-4"></div>
            <div className="flex justify-between mb-4">
              <span>Total</span>
              <span className="text-lg text-grayC">$230.00</span>
            </div>
            <button className="font-medium text-white px-5 py-2 text-base bg-darkYellow hover:opacity-80 rounded-sm block ml-auto">
              CHECKOUT
            </button>
          </div>
        </div>
