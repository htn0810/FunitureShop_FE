  ...
  return (
    <div className="mt-8">
      <Table
        ...
        pagination={false}
      />
      <div className="flex mt-8 font-tertiary">
        <div className="basis-1/2">
          <h5 className="text-xl font-medium text-white px-6 py-3 bg-softBlack">
            Coupon
          </h5>
          <div className="px-8 py-4 border border-grayC">
            <p>Enter your coupon code if you have one</p>
            <div className="mt-8 flex gap-x-4">
              <input
                type="text"
                placeholder="Coupon code"
                className="w-[300px] px-6 py-4 text-base font-thin outline-none border border-grayC"
              />
            </div>
          </div>
        </div>
