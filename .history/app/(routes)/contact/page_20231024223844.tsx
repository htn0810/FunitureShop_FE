            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              <div>
                ...
                <input
                  type="text"
                  id="name"
                  className="w-full px-3 py-2 outline-none mt-2 rounded-md border border-grayDarkC focus:border-darkYellow"
                />
              </div>
              <div>
                ...
                <input
                  type="text"
                  id="email"
                  className="w-full px-3 py-2 outline-none mt-2 rounded-md focus:border focus:border-darkYellow"
                />
              </div>
            </div>
            <div className="mt-4">
