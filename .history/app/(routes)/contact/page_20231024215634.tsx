import { LocationIcon, MailIcon, PhoneIcon } from "@/app/_icons";
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-8 font-tertiary text-grayC">
        <div className="columns-1 p-8 bg-grayF6">
          ...
          <div className="flex items-center gap-x-4 mt-4">
            ...
            <span className="text-sm md:text-base">htnxxx@gmail.com</span>
          </div>
          <div className="flex items-center gap-x-4 mt-4">
            <span className="p-3 rounded-full bg-darkYellow text-white">
              <LocationIcon />
            </span>
            <span className="text-sm md:text-base">Tân Bình, Hồ Chí Minh</span>
          </div>
        </div>
