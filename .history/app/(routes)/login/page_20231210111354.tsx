...
import { hideLoading, showLoading } from "@/app/_store/loading.slice";
import { EyeOpenIcon } from "@/app/_icons";
        ...
        >
          ...
          <div className="mb-6 relative">
            <input
              ...
              className={`relative w-full px-3 py-4 border border-solid focus:border-darkYellow outline-none${
                errors.password?.message ? "border-red-500" : ""
              }`}
            />
            <EyeOpenIcon className="absolute top-1/2 right-4 -translate-y-1/2 w-6 h-6 cursor-pointer hover:text-darkYellow"></EyeOpenIcon>
