  ...
  return (
    <Fragment>
      ...
      <div className="grid grid-cols-1 flex-row-reverse space-y-reverse lg:grid-cols-4 gap-8">
        <div className="order-2 lg:order-none bg-grayF6 font-tertiary">
          ...
          <h4 className="relative uppercase text-xl font-semibold text-black after:block after:absolute after:w-full after:h-[2px] after:-bottom-3 after:bg-darkYellow mt-6">
            Categories
          </h4>
        </div>
