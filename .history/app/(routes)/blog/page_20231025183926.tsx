          ...
          .map(() => (
            ...
            <div key={uuidv4()} className="font-tertiary">
              ...
              <p className="mt-4 text-sm md:text-base text-grayC leading-6 md:leading-8">
                ...
                Quisquam unde aliquid consectetur, dicta repellat cumque harum?
                Quas vero ut distinctio. Provident ex quibusdam aliquam,
                pariatur enim repudiandae vitae doloribus tempore.
              </p>
