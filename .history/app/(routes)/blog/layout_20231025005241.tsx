    ...
    <Fragment>
      ...
      <div className="grid grid-cols-1 flex-row-reverse space-y-reverse lg:grid-cols-4 gap-8">
        <div className="h-[200px] order-2 lg:order-none bg-grayF6 font-tertiary">
          <h4 className="relative uppercase text-xl font-semibold text-black after:block after:w-full after:absolute after:left-0 after:-bottom-2 after:h-1 after:bg-darkYellow">
            Search
          </h4>
        </div>
