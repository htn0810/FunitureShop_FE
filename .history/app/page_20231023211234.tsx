        ...
        <div className="grid grid-cols-1 md:grid-cols-2 2xl:grid-cols-3 gap-8">
          <div className="overflow-hidden">
            <Image
              src={Discover}
              alt="Blog Image"
              className="mb-5 hover:scale-105 transition-transform duration-200 ease-in cursor-pointer"
            ></Image>
            <h3 className="text-lg md:text-2xl font-semibold mb-3 cursor-pointer hover:text-darkYellow">
              Blog Title
            </h3>
          ...
          <div className="overflow-hidden">
            <Image
              src={Discover}
              alt="Blog Image"
              className="mb-5 hover:scale-x-105 transition-transform duration-200 ease-in cursor-pointer"
            ></Image>
            <h3 className="text-lg md:text-2xl font-semibold mb-3 cursor-pointer hover:text-darkYellow">
              Blog Title
            </h3>
