...
const Footer = () => {
  return (
    <div className="mt-24 bg-softYellow p-[15px] md:px-[40px] md:py-[25px] xl:px-[90px]">
      <div className="flex items-center justify-center bg-softYellow py-24 ">
        <div className="flex w-full flex-col items-center justify-center px-[15px] lg:flex-row">
          <div>
            <Image
              src={logo}
              alt="Logo"
