  ...
  return (
    <div className="mt-24 bg-softYellow">
      <div className="flex items-center justify-center bg-softYellow py-24 ">
        <div className="flex w-full flex-col items-center justify-center lg:flex-row  p-[15px] md:px-[40px] md:py-[25px] xl:px-[90px]">
          <div className="flex-1">
            ...
            <div className="mt-8 flex">
              <input
                className="w-3/4 rounded-tl-md rounded-bl-md bg-white px-6 py-3 outline-none"
                type="text"
                placeholder="Enter your email address"
              />
              <button className="px-6 py-3 text-white rounded-sm bg-black hover:bg-darkYellow t">
                Sign Up
              </button>
            </div>
      ...
      <div className="flex justify-center bg-lightYellow">
