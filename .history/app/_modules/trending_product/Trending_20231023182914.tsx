    ...
    <div className="flex flex-col items-center justify-center mt-32">
      ...
      <div className="mt-12 grid grid-cols-1 justify-center gap-y-5 gap-x-8 px-[15px] sm:grid-cols-2 lg:grid-cols-4">
        ...
        >
          ...
          <div className="flex flex-col items-center pt-3 duration-500 group-hover:bg-blueC">
            <h3 className="text-lg font-bold text-pinkC group-hover:text-white">
              Cantilever chair
            </h3>
            <span className="mt-3 mb-4 text-sm text-offBlueC group-hover:text-white">
              $42.00
            </span>
          </div>
        </div>
